<template>
    <div class="login-wrap">
        <el-form class="login-container" :rules="rules" :model="user" ref="userform">
            <h1 class="title">后台管理系统</h1>
            <el-form-item prop="name">
                <el-input type="text" v-model="user.name"  placeholder="用户账号" autocomplete="off"></el-input>
            </el-form-item>
        ...
        methods:{
            doLogin(){
                this.$refs.userform.validate(valid=>{
                    if (valid)
                    {
                        this.request.post("http://localhost:9090/login",this.user).then(rep=>{
                            if (rep.code === 200)
                            {
                                ...
                                localStorage.setItem("myenums",JSON.stringify(rep.data.myenums))


                                setrouter()

                                if (rep.data.role === 1 ||rep.data.role === 2 )
